<%@ Page Title="Student Record" Language="C#" MasterPageFile="~/Provost.Master" AutoEventWireup="true" CodeBehind="StudentRecord.aspx.cs" Inherits="hostel________.provost.StudentRecord" %>
...
<asp:Label ID="Label1" runat="server" Text="Search Student:  according to " 
    ...
    <asp:DropDownList ID="DropDownList4" runat="server" 
        DataSourceID="SqlDataSource8" DataTextField="District" 
    ...
    <asp:SqlDataSource ID="SqlDataSource8" runat="server" 
        ...
        SelectCommand="SELECT DISTINCT [District] FROM [StudentData] ORDER BY [District]">
    </asp:SqlDataSource>
    &nbsp;&nbsp;
...
&nbsp;&nbsp;
    ...
    <asp:SqlDataSource ID="SqlDataSource6" runat="server" 
        ...
        SelectCommand="SELECT [Room_No], [Date], [Name], [Enrollment_No], [Course], [Batch], [Semester], [Faculty], [Fauculty_No], [Department], [DOB], [SplCat], [Father_Name], [Mother_Name], [Permanent_Address], [District], [State], [Home_Phone_No], [Id], [Photo], [MobileNo] FROM [StudentData] WHERE ([District] = @District)" 
        ...
        <SelectParameters>
            <asp:ControlParameter ControlID="DropDownList4" Name="District" 
    ...
    <br />
     ...
     <div style=" overflow: auto;   ">
    <asp:GridView ID="GridView7" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource6" 
        DataKeyNames="Enrollment_No" Width="145px" BackColor="#CCCCCC" 
            BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" 
            CellSpacing="2" ForeColor="Black" AllowSorting="True" 
            EmptyDataText="No Record Found" Visible="False"  >
        <Columns>
            <asp:BoundField DataField="Room_No" HeaderText="Room_No" 
                SortExpression="Room_No" >
            </asp:BoundField>
