<%@ Page Title="" Language="C#" MasterPageFile="~/munshi.Master" AutoEventWireup="true" CodeBehind="inventry_goods_in.aspx.cs" Inherits="hostel________.munsi.inventry_goods_in" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
 <h1 align="center">Add Goods in Stock</h1>
 <table class="style1">
    <tr>
        <td>
            Goods Name</td>
    ...
    <tr>
        <td>
            &nbsp;</td>
        <td>
            <asp:Button ID="Button1" runat="server" Text="Goods Add" 
