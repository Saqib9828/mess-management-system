<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="munsilogin.aspx.cs" Inherits="hostel________.munsi.munsilogin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
 <fieldset style="width: 60%; height: 100%; margin-left: 20%; margin-right: 20%; margin-top: 5%; font-family: 'Times New Roman', Times, serif; font-size: medium;" >
        <legend style="font-family: 'Times New Roman', Times, serif; font-size: xx-large; color: #0066CC; font-weight: bold">Munshi Login</legend>
